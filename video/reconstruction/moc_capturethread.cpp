...
**
** Created: Sun Jun 16 14:11:04 2013
...
static const char qt_meta_stringdata_CaptureThread[] = {
    "CaptureThread\0\0,\0imageAquired(QImage,int)\0"
};
...
int CaptureThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: imageAquired((*reinterpret_cast< QImage(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 1;
    }
...
// SIGNAL 0
void CaptureThread::imageAquired(QImage _t1, int _t2)
{
