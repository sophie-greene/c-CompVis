...
void add_coloured_meshes(std::vector <IplImage*> ims, std::vector<std::vector<std::vector<pcl::PointXYZINormal>>> surfaces, std::vector<cam_params_t>& params,pcl::visualization::PCLVisualizer &viewer, float final_smooth_r);
