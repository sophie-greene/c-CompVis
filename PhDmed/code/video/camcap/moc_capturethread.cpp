...
**
** Created: Wed Jun 12 14:11:02 2013
...
static const char qt_meta_stringdata_CaptureThread[] = {
    "CaptureThread\0\0imageAquired(Mat)\0"
};
...
int CaptureThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: imageAquired((*reinterpret_cast< Mat(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
...
// SIGNAL 0
void CaptureThread::imageAquired(Mat _t1)
{
