...
static const char qt_meta_stringdata_CalibrateThread[] = {
    "CalibrateThread\0\0,\0calibrationSuccess(QImage,int)\0"
};

void CalibrateThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        CalibrateThread *_t = static_cast<CalibrateThread *>(_o);
        switch (_id) {
        case 0: _t->calibrationSuccess((*reinterpret_cast< QImage(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData CalibrateThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CalibrateThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CalibrateThread,
      qt_meta_data_CalibrateThread, &staticMetaObjectExtraData }
};
...
// SIGNAL 0
void CalibrateThread::calibrationSuccess(QImage _t1, int _t2)
{
