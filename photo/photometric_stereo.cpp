...
int main() {
	...
	*/
	...
	for (int i = 0; i < CAM_NUM; i++) {
		...
		vector<vector<cv::Mat>> normals = calc_normal_map(image_list_gray, mask_image,light_dirs,M,params[i].trans,low_normal_intens_tresh_,high_normal_intens_tresh_,normal_weight_);
	...
	*/
	...
	vector<IplImage*> full_res_ims(CAM_NUM);
	vector<IplImage*> full_res_masks(CAM_NUM);
