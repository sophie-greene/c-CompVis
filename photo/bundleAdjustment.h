...
void create_avg_surface(std::vector<pcl::PointCloud<pcl::PointXYZINormal>::Ptr> clouds,pcl::visualization::PCLVisualizer &viewer, pcl::PolygonMesh &triangles,pcl::PointCloud<pcl::PointXYZ>::Ptr &mls_points, float voxel_size,float);
